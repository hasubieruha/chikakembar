...
function init() { 
    ...
    gameOn = true;
     ...
     blockFrontImages = ["Images/chika1.jpg",
        "Images/chika2.jpg",
        "Images/chika3.jpg",
        "Images/chika4.jpg",
        "Images/chika5.jpg",
    ...
    document.getElementById("Flips").innerText = `${flipCounter} kali ngebalik gambar`;
    createElements();
}
...
function createElements() {
    ...
    for (var i = 0; i < finalCount; i++) {
        ...
        blockData = new MemoryBlock(i, cardFront, "Images/chikaback.jpg");
